  ...
  const { error } = await supabase.from('spaces').upsert(
    {
      ...
      color: space.color || '',
      category_order: space.categoryOrder || [],
      adoracion_dia: typeof space.adoracionDia === 'number' ? space.adoracionDia : null,
      adoracion_hora: space.adoracionHora || '',
      adoracion_hora_fin: space.adoracionHoraFin || '',
      adoracion_lugar: space.adoracionLugar || '',
      adoracion_invitacion: space.adoracionInvitacion || '',
      adoracion_canciones: space.adoracionCanciones || [],
    ...
    for (const remote of remoteSpaces) {
      ...
      if (remote.deleted_at) {
        ...
        merged.set(remote.key, {
          ...
          color: remote.color || '',
          categoryOrder: remote.category_order || [],
          adoracionDia: typeof remote.adoracion_dia === 'number' ? remote.adoracion_dia : null,
          adoracionHora: remote.adoracion_hora || '',
          adoracionHoraFin: remote.adoracion_hora_fin || '',
          adoracionLugar: remote.adoracion_lugar || '',
          adoracionInvitacion: remote.adoracion_invitacion || '',
          adoracionCanciones: remote.adoracion_canciones || [],
