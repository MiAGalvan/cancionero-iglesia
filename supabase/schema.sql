...
create table if not exists spaces (
  ...
  category_order jsonb not null default '[]', -- orden de las carpetas del cancionero (fijas + agregadas) elegido con ▲/▼ en "Cancionero" — sin esto, cada dispositivo del equipo podía terminar viendo un orden distinto
